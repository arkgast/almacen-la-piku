...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('producto', '__first__'),
        ('cliente', '0004_historicalpedidocliente'),
    ]

    operations = [
        migrations.CreateModel(
            name='HistoricalDetallePedidoCliente',
            fields=[
                ...
                ('pedido', models.ForeignKey(related_name='+', on_delete=django.db.models.deletion.DO_NOTHING, db_constraint=False, blank=True, to='cliente.PedidoCliente', null=True)),
